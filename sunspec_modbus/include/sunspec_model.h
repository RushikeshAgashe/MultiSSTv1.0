...
#define SUNS_MODEL                  "SST_1"
#define SUNS_VERSION                "v1.0"
#define SUNS_SERIAL_NUMBER          "1PDF65SD4FXX09"

#define STANDARD_MODEL_OFFSET       (COMMON_MODEL_OFFSET + COMMON_MODEL_PDU_LENGTH + HEADER_LENGTH)
#define STANDARD_MODEL_ID           64162   /* Example */
#define STANDARD_MODEL_PDU_LENGTH   22
...
typedef struct StandardModel{
    ...
    suns_int32 Vldc;
    suns_int32 Iinv_ref;
    suns_int32 Iinv_ref_ramp_rate_per_s;
    suns_int32 Iinv;
    suns_int32 Iinv_rms;
    suns_int32 Iload_rms;
    suns_int16 E3_sf;
    suns_uint16 pad;
}StandardModel_S;
